...
var requestCatButton = document.getElementById("dogButton");
requestCatButton.addEventListener("click",getDogPhoto);

var requestDogButton = document.getElementById("catButton");
requestDogButton.addEventListener("click",getCatPhoto);
